...
const Education = () => {
    return (<section className="container-wrapper h-max min-h-[calc(100vh-5rem)] justify-center lg:justify-start sm:h-full snap-start flex flex-col py-20 gap-y-8 lg:gap-y-0" id="education" >
